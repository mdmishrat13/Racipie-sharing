...
const Register = () => {
  return (
    <section style={{'--image-url': `url(${image})`,}}  className="bg-no-repeat bg-cover bg-[image:var(--image-url)]">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="font-light text-gray-50 dark:text-gray-300">I accept the <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a></label>
                </div>
              </div>
